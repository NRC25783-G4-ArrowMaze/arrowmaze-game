...
- ❌ Confundir "salida tomada" con "todo lo que generó la IA" — solo lo que el equipo adoptó
 i-usage", "reporte de IA", "registro de uso de IA",
  "documentar uso de Claude/GPT/Copilot", "AI usage report", "generar reporte de herramienta IA",
  o cuando quiera registrar qué herramientas de IA usó, cómo las usó, qué generaron, y qué
  modificaciones hicieron los humanos. También aplica cuando el usuario comparte una conversación
  o sesión de trabajo y quiere un resumen de uso al final. Funciona con input manual (datos dados
  directamente) o con conversaciones completas pegadas en el chat.
---
