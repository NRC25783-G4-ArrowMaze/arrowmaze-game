...
- **Validación realizada:** `tsc --noEmit` limpio; `eslint` sin hallazgos en
  el archivo modificado; suite completa `pnpm test` (jest) — 34 suites / 323
  tests en verde, sin regresiones. Commit `86a8b129` en la rama
  `fix/verificacion-avance-siguiente-nivel`.
